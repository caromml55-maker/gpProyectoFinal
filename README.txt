...
a persistence unit "gproyectoFinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gproyectoFinal/pom.xml":
...
artifact ("gproyectoFinal.war") is already built. You can build
